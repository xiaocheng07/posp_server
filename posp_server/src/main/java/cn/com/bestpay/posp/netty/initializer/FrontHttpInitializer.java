package cn.com.bestpay.posp.netty.initializer;
...
import cn.com.bestpay.posp.netty.factory.SecureChatSslContextFactory;
import cn.com.bestpay.posp.netty.handler.HttpServerHandler;
import cn.com.bestpay.posp.netty.httpserver.BackHttpServer;


public class FrontHttpInitializer extends ChannelInitializer<SocketChannel> {
	@Override
	public void initChannel(SocketChannel ch) throws Exception {
		// Create a default pipeline implementation.
		ChannelPipeline pipeline = ch.pipeline();

		if (BackHttpServer.isSSL) {
